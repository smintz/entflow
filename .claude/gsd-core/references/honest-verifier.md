...
`@/Users/smintz/go/src/github.com/smintz/entflow/.claude/gsd-core/references/edge-probe.md` (which *classifies* non-inferable checks) and
`@/Users/smintz/go/src/github.com/smintz/entflow/.claude/gsd-core/references/prohibition-probe.md` (whose judgment-tier disposition this mirrors).

...
**Verification depth scales with `asvs_level`** (see @/Users/smintz/go/src/github.com/smintz/entflow/.claude/gsd-core/references/security-asvs-levels.md for full definitions):

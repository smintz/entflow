...
- [x] 01-02-PLAN.md — Runtime services: scoped DI registry, Codec with WithCodec, Result[T], and StepError

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 01-03-PLAN.md — Full step-kind surface and execution semantics: seven DB constructors, declarable Activity/Emit, ordering, conditions, recovery, RunInTx
...
- [x] 02-02-PLAN.md — Tracer: `Start` → claim → one step in one transaction → done, plus the ratified dialect matrix

**Wave 3** *(blocked on Wave 2, run in parallel)*

- [x] 02-03-PLAN.md — Postgres claiming under concurrency: `FOR UPDATE SKIP LOCKED`, testcontainers, the claim-strategy conformance suite
- [x] 02-04-PLAN.md — Persisted results, live `self`, and honest terminal states with DB-step retry

**Wave 4** *(blocked on Wave 3)*

- [x] 02-05-PLAN.md — Runs as an ops surface: the workflow marker, `Policy()`, cancellation, and ordinary ent queries
...
- [x] 02-07-PLAN.md — Worker lifecycle: jittered polling, graceful shutdown, and both deployment topologies
